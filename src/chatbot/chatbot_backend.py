...
class ChatBot:
    ...
    def respond(chatbot: List, message: str) -> Tuple:
        ...
        system_prompt = (
            "You are a helpful assistant for retrieving clinical information. Call the `lookup_clinical_notes` tool to search the database for all the queries"
            "When asked about anything use the `lookup_clinical_notes` tool to search the database. "
